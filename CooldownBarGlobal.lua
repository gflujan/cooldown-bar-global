		...
		general =
		{
			...
			args =
			{
				...
				width =
				{
					...
					get = function(info) return profileDB.w end,
				},
				height =
				{
					order = 5,
					...
					get = function(info) return profileDB.h end,
				},
				barType =
				{
					order = 6,
					...
					set = function(info, value) profileDB.barType = value CooldownBarGlobal:SetupFrame() end,
					get = function(info) return profileDB.barType end,
				},
				secondheader =
				{
					order = 7,
				...
				bartexture =
				{
					...
					get = function() return profileDB.bartexture end,
				...
				backgroundtexture =
				{
					...
					values = AceGUIWidgetLSMlists.statusbar,
					get = function() return profileDB.backgroundtexture end,
					set = function(info, value)
				...
				lagtexture =
				{
					...
					values = AceGUIWidgetLSMlists.statusbar,
					get = function() return profileDB.lagtexture end,
					set = function(info, value)
				...
				spark =
				{
					...
					type = "toggle",
					set = function(info, value) profileDB.spark = value end,
					get = function(info) return profileDB.spark end,
				},
				combatOnly =
				{
					order = 16,
					...
					type = "toggle",
					set = function(info, value) profileDB.combatOnly = value end,
					get = function(info) return profileDB.combatOnly end,
				},
				moveMode =
				{
					order = 17,
					...
					get = function(info) return moveMode end,
				},
			},
		},
    },
...
function CooldownBarGlobal:SetupFrame()
	...
	if profileDB.y > 0 then profileDB.y = profileDB.y * -1 end
